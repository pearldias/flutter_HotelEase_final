...
class DeluxeRoomDetailPage extends StatefulWidget {
  const DeluxeRoomDetailPage({super.key});

  @override
  _DeluxeRoomDetailPageState createState() => _DeluxeRoomDetailPageState();
}

class _DeluxeRoomDetailPageState extends State<DeluxeRoomDetailPage> {
