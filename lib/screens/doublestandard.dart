...
class DoubleStandardRoomDetailPage extends StatefulWidget {
  const DoubleStandardRoomDetailPage({super.key});
  @override
  _DoubleStandardRoomDetailPageState createState() => _DoubleStandardRoomDetailPageState();
}
class _DoubleStandardRoomDetailPageState extends State<DoubleStandardRoomDetailPage> {
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => BookingForm()), // Navigate to BookingForm
                  );
                },
